...
class DoctorProfileViewBodyDetailsAndAppointmentsSection
    extends StatefulWidget {
      final DoctorDataModel dataDataModel;
  const DoctorProfileViewBodyDetailsAndAppointmentsSection({super.key, required this.dataDataModel});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          verticalSpace(8),
           Text(
              widget.dataDataModel.description??"",
